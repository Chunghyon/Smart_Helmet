/*!
    ...
    \version %%version
    \file 
    \brief The bt_device marshal type definitions. This file is generated by C:/qtil/QCC3044/qcc514x-qcc304x-src-1-0_qtil_standard_oem_headset-master-ORG/adk/tools/packages/typegen/typegen.py.
*/
...
static const marshal_member_descriptor_t bt_device_pdd_t_member_descriptors[] =
{
    ...
    MAKE_MARSHAL_MEMBER(bt_device_pdd_t, uint8, handset_account_key_index),
    /*! Connection Switch flag for SASS */
    MAKE_MARSHAL_MEMBER(bt_device_pdd_t, uint8, sass_switch_disabled),
    /*! Gatt service discovery flag */
    MAKE_MARSHAL_MEMBER(bt_device_pdd_t, uint8, gsd_completed),
} ;
