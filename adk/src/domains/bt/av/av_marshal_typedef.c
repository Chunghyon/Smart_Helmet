/*!
    ...
    \version %%version
    \file 
    \brief The av marshal type definitions. This file is generated by C:/qtil/QCC3044/qcc514x-qcc304x-src-1-0_qtil_standard_oem_headset-master-ORG/adk/tools/packages/typegen/typegen.py.
*/
