/*!
    ...
    \version %%version
    \file 
    \brief The mirror_profile c type definitions. This file is generated by C:/qtil/QCC3044/qcc514x-qcc304x-src-1-0_qtil_standard_oem_headset-master-ORG/adk/tools/packages/typegen/typegen.py.
*/
...
typedef struct 
{
    ...
    uint8 sink_phy;
    /*! Sink frame length */
    uint16 sink_frame_length;
    /*! Sink Frame Blocks per sdu */
    uint8 sink_blocks_per_sdu;
    ...
    uint8 source_phy;
    /*! Source frame length */
    uint16 source_frame_length;
    /*! Source Frame Blocks per sdu */
    uint8 source_blocks_per_sdu;
...
typedef struct 
{
    /*! Not used */
    uint8 dummy;
} mirror_profile_lea_unicast_audio_clear_req_t;
