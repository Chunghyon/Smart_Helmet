/*!
    ...
    \version %%version
    \file 
    \brief The dfu_peer_sig c type definitions. This file is generated by C:/qtil/QCC3044/qcc514x-qcc304x-src-1-0_qtil_standard_oem_headset-master-ORG/adk/tools/packages/typegen/typegen.py.
*/
...
/*! Peer indication to sync revert reboot between Primary and Secondary */
typedef struct 
{
    /*! unused */
    uint8 dummy;
} dfu_peer_sync_revert_reboot_t;
