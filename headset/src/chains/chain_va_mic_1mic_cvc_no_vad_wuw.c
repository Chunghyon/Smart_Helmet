/*!
    ...
    \file chain_va_mic_1mic_cvc_no_vad_wuw.c
...
static const operator_connection_t connections[] =
{
    ...
    {OPR_CVC_SEND, CVC_1MIC_VA_OUTPUT_TERMINAL, OPR_SPLITTER, 0, 1},
} ;

const chain_config_t chain_va_mic_1mic_cvc_no_vad_wuw_config = {0, 0, operators, 3, inputs, 2, outputs, 2, connections, 2};
