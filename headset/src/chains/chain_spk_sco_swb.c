...
static const operator_config_t operators[] =
{
    ...
    MAKE_OPERATOR_CONFIG(CAP_ID_CVCSPKR1MIC_SEND_SWB, OPR_CVC_SEND),
} ;
...
const chain_config_t chain_spk_sco_swb_config = {1, 0, operators, 4, inputs, 3, outputs, 2, connections, 2};
