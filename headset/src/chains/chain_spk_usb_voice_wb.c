...
static const operator_config_t operators[] =
{
    ...
    MAKE_OPERATOR_CONFIG(CAP_ID_CVCSPKR1MIC_SEND_WB, OPR_CVC_SEND),
} ;
...
const chain_config_t chain_spk_usb_voice_wb_config = {0, 0, operators, 3, inputs, 3, outputs, 2, connections, 1};
