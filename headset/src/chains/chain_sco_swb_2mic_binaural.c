/*!
    ...
    \file chain_sco_swb_2mic_binaural.c
...
static const operator_config_t operators[] =
{
    ...
    MAKE_OPERATOR_CONFIG(CAP_ID_CVCHS2MIC_BINAURAL_SEND_SWB, OPR_CVC_SEND),
} ;
...
const chain_config_t chain_sco_swb_2mic_binaural_config = {0, 0, operators, 4, inputs, 4, outputs, 2, connections, 2};
