/*!
    ...
    \file chain_input_sbc_stereo.c
    \brief The chain_input_sbc_stereo chain.
...
static const operator_endpoint_t outputs[] =
{
    ...
    {OPR_SBC_DECODER, EPR_SOURCE_DECODED_PCM_RIGHT, 1},
} ;
...
const chain_config_t chain_input_sbc_stereo_config_p0 = {0, 0, operators_p0, 2, inputs, 1, outputs, 2, connections, 1};

const chain_config_t chain_input_sbc_stereo_config_p1 = {0, 0, operators_p1, 2, inputs, 1, outputs, 2, connections, 1};
