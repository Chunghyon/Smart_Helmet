...
static const operator_connection_t connections[] =
{
    ...
    {OPR_SPEAKER_EQ, 1, OPR_REMOVE_HEADROOM, 1, 1},
} ;

const chain_config_t chain_music_processing_config_p0 = {0, 0, operators_p0, 3, inputs, 2, outputs, 2, connections, 4};

const chain_config_t chain_music_processing_config_p1 = {0, 0, operators_p1, 3, inputs, 2, outputs, 2, connections, 4};
