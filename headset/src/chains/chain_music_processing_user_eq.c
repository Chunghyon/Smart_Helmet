...
static const operator_endpoint_t inputs[] =
{
    ...
    {OPR_ADD_HEADROOM, EPR_MUSIC_PROCESSING_IN_R, 1},
} ;

static const operator_endpoint_t outputs[] =
{
    {OPR_REMOVE_HEADROOM, EPR_MUSIC_PROCESSING_OUT_L, 0},
    {OPR_REMOVE_HEADROOM, EPR_MUSIC_PROCESSING_OUT_R, 1},
} ;

static const operator_connection_t connections[] =
{
    {OPR_ADD_HEADROOM, 0, OPR_SPEAKER_EQ, 0, 1},
    {OPR_ADD_HEADROOM, 1, OPR_SPEAKER_EQ, 1, 1},
    {OPR_SPEAKER_EQ, 0, OPR_USER_EQ, 0, 1},
    {OPR_SPEAKER_EQ, 1, OPR_USER_EQ, 1, 1},
    {OPR_USER_EQ, 0, OPR_REMOVE_HEADROOM, 0, 1},
    {OPR_USER_EQ, 1, OPR_REMOVE_HEADROOM, 1, 1},
} ;

const chain_config_t chain_music_processing_user_eq_config_p0 = {0, 0, operators_p0, 4, inputs, 2, outputs, 2, connections, 6};

const chain_config_t chain_music_processing_user_eq_config_p1 = {0, 0, operators_p1, 4, inputs, 2, outputs, 2, connections, 6};
